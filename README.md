...
Installation
---
[Download Pandemix](https://github.com/justsz/pandemix/releases/tag/v0.1)  
To use Pandemix in your web page, you need to include it in your HTML. If all you need is Pandemix, include pandemix-min.js, pandemix.css and sprites.png in your HTML. However, Pandemix depends on D3 and Crossfilter for most things and Leaflet for maps, so you should include a copy of those as well.  
